...
let alubumOneLable =album1.albumDetails.label;
...
album3.albumDetials.formats.push(album2.albumDetials.formats[0]);
...
album7.labels=album7.lables.split(", ");
...
console.log('The number '+x+ ' is not divisible by 2 or 3')
