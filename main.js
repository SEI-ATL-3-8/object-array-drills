  ...
  */
  ...
  for (guest of tickets){
    if(guest.type === "premium"){
        console.log("Welcome, ", guest.name ,"! You may sit anywhere in the first 3 rows of the right section.");
    }
    else if(guest.type === "standard"){
        console.log("Welcome, ", guest.name ,"! You and your party may sit anywhere except first 3 rows of the center section. Please be sure to leave no seats between you.");
    }
  ...
  for(patron of tickets2){
    ...
    if(patron.zombie) {
      ...
      if(patron.amount == 90.00){
        console.log("Premier Plus");
        continue;
      }
      else if(patron.amount == 80.00 && patron.discount){
          console.log("Premier Plus");
          continue;
      }
      else if(patron.amount == 65.00){
        str = "Premier";
      }
      else if(patron.amount == 50.00){
          str = "Standard";
      }
